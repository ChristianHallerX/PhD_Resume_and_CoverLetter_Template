...
\href{mailto:foobar@hmail.xyz}{mail@hmail.xyz \faEnvelope}\\\vspace{2 mm}         % plug in your email address
\section{profiles}\vspace{2 mm}
\href{http://examplepage.org/}{examplepage.org~\faFirefox}\\                      % plug in your website
